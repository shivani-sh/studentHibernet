...
<table style="width: 600px" class="reference">
    ...
    <tr class="tr">
        ...
        <td><a href="<c:url value="/delete/${student.id}"/> " class="btn btn-outline-danger" role="button">Delete</a></td>


       <td> <a href="<c:url value="/update/${student.id}"/>" class="btn btn-outline-success" role="button">Update</a></td>
    </tr>
        </c:forEach>
